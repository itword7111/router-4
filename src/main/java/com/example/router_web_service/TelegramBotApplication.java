    ...
    private void executeCommand(String commandName, Long chatId, String userName){
        switch (commandName) {
            ...
            case "/add_track": {
                ...
                List<String> s=routerSenderService.getOneDaysNotTrackingUsers();
                List<String> ss=routerSenderService.getThreeDaysNotTrackingUsers();
                List<ReportSender> sss=routerSenderService.getReportsToday();
